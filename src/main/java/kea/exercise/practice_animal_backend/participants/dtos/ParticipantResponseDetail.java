...
public record ParticipantResponseDetail(int id, String name, LocalDate birthDate, int age, String ageGroup, Club club, Gender gender, List<ResultResponseDTO> results, Set<Discipline> disciplines) {
}
